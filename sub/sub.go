...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	// Subscription output is part of the paid panel. Keep the listener alive so
	// configuration does not need to be rebuilt after renewal, but refuse all
	// subscription traffic while the signed license is inactive.
