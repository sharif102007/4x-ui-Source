...
class Inbound extends XrayCommonClass {
    constructor(
        ...
        this.payloadBypass = !!payloadBypass;
        this.payloadBackendPort = Number(payloadBackendPort || 0);
    }
    getClientStats() {
    ...
    toJson() {
        ...
        return {
            ...
            payloadBypass: this.payloadBypass,
            payloadBackendPort: this.payloadBackendPort
        };
    }
}
